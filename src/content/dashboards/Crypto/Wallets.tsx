...
debugger
  ...
  return (
    <>
      ...
      >
        <Typography variant="h3">Sectoredds</Typography>
        {/* <Button
          size="small"
          variant="outlined"
      ...
      <Grid container spacing={3}>
            ...
            >
              <CardContent>
                ...
                >
                  ...
                  <Typography>
                    <Text color="black">
                      <b> $ {item.subtotal}</b> deuda
                    </Text>
                  </Typography>
                  <Typography>
                    <Text color="success">
                      <b> $ {item.abonos}</b> abonos
                    </Text>
                  </Typography>

                  <Typography>
                    <Text color="success">
                      <b> $ {item.abonoMensual}</b> mensual
                    </Text>
                  </Typography>
                </Box>
              </CardContent>
        ...
        <ModalSector showModal={showModalDelete} value={openDelete} />
      </Grid>
    </>
  );
};
